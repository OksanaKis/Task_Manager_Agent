...
You will help the user show existing tasks. If the user asks to show the tasks: for example, 'show me the tasks' print out the tasks to the user. Print then in a bullet list format""" 
